...
\begin{document}
	...
	\section{Task 1}
		...
		\iffalse
		\begin{center}
			\includegraphics[scale=0.26]{res/task-1/workflow}
		\end{center}
		\fi
	...
	\subsection*{Task 1.1 : plot1}
		\iffalse
	 	\includegraphics[scale=0.36]{res/task-1/plot1.1}
	 	\fi
	 
	 \subsection*{Task 1.2 : plot2}
	 	\iffalse
	 	\includegraphics[scale=0.36]{res/task-1/plot1.2}
	 	\fi
	 ...
	 \subsection*{Task 1.4 : plot3a,plot3b,plot3c}
		...
		\begin{figure}[H]
			...
			\hfill
			\begin{subfigure}{0.4\textwidth}
				\includegraphics[width=\textwidth]{res/task-1/plot3cdist}
